...
class UserRoleInterceptorTest {
  ...
  void successTest() {
    ...
    // then
    boolean result = assertDoesNotThrow(() -> userRoleInterceptor.preHandle(request, response, new Object()));
    assertTrue(result);
  }
  ...
  void checkUserRoleTest() {
    ...
    UnauthorizedException exception = assertThrows(UnauthorizedException.class, () ->
            userRoleInterceptor.preHandle(request, response, new Object()));

    assertEquals(HttpStatus.UNAUTHORIZED, exception.getStatusCode());
    assertEquals("USER 권한이 필요합니다.", exception.getReason());
  }
